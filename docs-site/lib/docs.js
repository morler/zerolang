export const docs = [
  ...
  },
  {
    slug: "install",
    title: "Install Guide",
    description: "Build the local compiler and validate your environment.",
    path: "/install",
  ...
  },
  {
    ...
    description: "Current C ABI export support and staged interop boundaries.",
    path: "/c-interop",
  ...
  },
  {
    slug: "module-parse",
    title: "std.parse",
    description: "Source positions, spans, cursors, ASCII scanners, tokens, and parse diagnostics.",
    path: "/modules/parse",
  ...
  },
  {
    slug: "module-json",
    title: "std.json",
    description: "Dynamic JSON values, owned documents, and parse/stringify diagnostics.",
    path: "/modules/json",
  ...
  },
  {
    slug: "module-toml",
    title: "std.toml",
    description: "Focused TOML value and document model with configuration diagnostics.",
    path: "/modules/toml",
  ...
  },
  {
    ...
    title: "std.contract",
    description: "Validation issues, bounded paths, reports, and common checks.",
    path: "/modules/contract",
    sourcePath: "/articles/modules/contract.md",
    section: "Modules",
  },
  {
    slug: "module-env",
    title: "std.env",
    description: "Layered config sources, dotenv parsing, typed decode, and redaction.",
    path: "/modules/env",
  ...
  },
  {
    slug: "module-id",
    title: "std.id",
    description: "UUIDs, ULID-style IDs, NanoID-style buffers, and typed IDs.",
    path: "/modules/id",
    sourcePath: "/articles/modules/id.md",
    section: "Modules",
  },
  {
    slug: "module-time",
    title: "std.time",
    description: "Duration, instant, deadline, budget, and explicit clock primitives.",
    path: "/modules/time",
  ...
  {
    slug: "module-fs-atomic",
    title: "std.fs.atomic",
    description: "Atomic rename replacement with explicit durability policy.",
    path: "/modules/fs-atomic",
    sourcePath: "/articles/modules/fs-atomic.md",
    section: "Modules",
  },
  {
    slug: "module-store",
    title: "std.store",
    description: "WAL, page, segment, and snapshot format primitives.",
    path: "/modules/store",
    sourcePath: "/articles/modules/store.md",
    section: "Modules",
  },
  {
    slug: "module-sync",
    title: "std.sync",
    description: "Cancellation, latch, backpressure, bounded queues, and in-flight keys.",
    path: "/modules/sync",
    sourcePath: "/articles/modules/sync.md",
    section: "Modules",
  },
];
